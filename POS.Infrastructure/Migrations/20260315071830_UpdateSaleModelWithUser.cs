...
{
    /// <inheritdoc />
    public partial class UpdateSaleModelWithUser : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoxTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BoxTransactions_Shifts_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoxTransactions_ShiftId",
                table: "BoxTransactions",
                column: "ShiftId");
